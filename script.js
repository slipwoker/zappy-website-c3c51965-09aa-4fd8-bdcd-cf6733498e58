    ...
    function validateField(field) {
        ...
        if (isValid && field.hasAttribute('minlength') && value !== '') {
            ...
            if (value.length < minLength) {
                isValid = false;
                errorMessage = field.dataset.errorMinlength || `Minimum ${minLength} characters required`;
            }
        }
            ...
            if (!hasErrors) {
                ...
                .then(function() {
                    ...
                    if (successMessage) {
                        ...
                        successMessage.textContent = successMessage.dataset.message || 'Form submitted successfully!';
                    }
                })
                .catch(function() {
                    if (errorMessage) {
                        errorMessage.style.display = 'block';
                        errorMessage.textContent = errorMessage.dataset.message || 'An error occurred. Please try again.';
                    }
                })
                .finally(function() {
                    if (submitButton) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'c3c51965-09aa-4fd8-bdcd-cf6733498e58',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c3c51965-09aa-4fd8-bdcd-cf6733498e58';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c3c51965-09aa-4fd8-bdcd-cf6733498e58';
